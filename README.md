...
| squid_cache_dir                     | {}                                                          | Cache directory (keys: type, path, options)                                                           |
...
| squid_maximum_object_size           | ""                                                          | Set the default value for max-size paramater on any cache dir                                          |
...
| squid_refresh_patterns              | [{ regex: "^ftp:", min: 1440, percent: "20%", max: 10080 }, { regex: "^gopher", min: 1440, percent: "0%", max: 1440 }, { case_ins: true, regex: "(/cgi-bin/\|\?)", min: 0, percent: "0%", max: 0 }, { regex: "(Release\|Packages(.gz)*)$", min: 0, percent: "0%", max: 2880 }, { regex: ".", min: 0, percent: "20%", max: 4320 }] | Reverse patterns                                                                                       |
